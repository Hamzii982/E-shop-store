    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" >
                    <div class="card-body">
                        <h3 class="card-title text-uppercase font-medium font-18">Edit Category Detail</h3><hr>
                        <?php
                            foreach($result as $row)
                            {
                        ?>
                        <form method='post' class="form-horizontal form-material" action="<?=base_url('CategoryController/edit')?>">
